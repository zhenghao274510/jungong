	...
	<view class="content">
			<view class="list-con">
				...
				<view class="d-flex d-between d-items-center d-border">
					...
					<input type="number" value="" class="reg-input" placeholder="验证码" placeholder-style="color:#999999" v-model="YZM" />
				...
				<view class="d-flex d-between d-items-center d-border">
					...
					<input type="text" value="" class="reg-input" placeholder="登录密码" placeholder-style="color:#999999" v-model="inverteCode" />
				</view>
			</view>
				<view class="reg-btn" hover-class="btnHover" @click="subOrder">完 成</view>
				<view class="xieyi-con">
					<label>
						<checkbox value="" checked="true" color="#09BB07" style="transform:scale(0.7)" /><text class="login-xieyi">我已阅读并同意</text><text class="login-xieyi" style="color: #00B900;">《XXX公众用户协议》</text>
					</label>
				</view>
