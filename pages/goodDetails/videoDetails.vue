	...
	<view class="eva-section pad-page">
		<view class="eva-box">
			<view class="eva-content">
				...
				<view class="eva-img-con" v-if="dataobject.image.length!=0">
					<image class="img" v-for=" (m,n) in dataobject.image" :key="n" :src="m" mode="widthFix" @click="ImgDetails(n)"></image>
				</view>
				
				<view class="uni-flex" style="flex-wrap: wrap;" v-if="dataobject.label">
					<view class="link-text title-nav" :class="{'tapTargetOne':k%3==0,'tapTargetTwo':k%3==1,'tapTargetThree':k%3==2}"
					 v-for="(v,k) in dataobject.label" :key="k">{{v}}</view>
				</view>
				<view class="uni-flex" style="flex-wrap: wrap;" v-if="dataobject.items">
					<view class="link-text title-nav" :class="{'tapTargetOne':k%3==0,'tapTargetTwo':k%3==1,'tapTargetThree':k%3==2}"
					 v-for="(v,k) in dataobject.items" :key="k">{{v}}</view>
				</view>
			</view>
		</view>
