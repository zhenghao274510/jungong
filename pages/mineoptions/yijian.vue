	...
	<view class="content">
		...
		<evan-form class="center-con" :hide-required-asterisk="hideRequiredAsterisk" label-position="top" ref="form" :model="massageinfo">
			<evan-form-item prop="name">
				<input class="center-input" placeholder-class="placeholder" v-model="massageinfo.name" placeholder="请输入要投诉人姓名">
			</evan-form-item>
			<evan-form-item prop="address">
				<view class="center-input uni-flex d-items-center">
					<input class="uni-flex-item" placeholder-class="placeholder" v-model="massageinfo.address" placeholder="工作地址">
			...
			<evan-form-item prop="content" class="item-con">
				<view class="mian-con">
					<textarea v-model="massageinfo.content" placeholder="请输入投诉内容！（不多于500字）" class="textarea" />
					</view>
				</evan-form-item>
				<evan-form-item prop="content" class="item-con">
