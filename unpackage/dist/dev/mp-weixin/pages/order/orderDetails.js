...
/***/ 263:
/*!*******************************************************************************!*\
  !*** D:/lixindom/2020/parent/main.js?{"page":"pages%2Forder%2ForderDetails"} ***!
  \*******************************************************************************/
...
var _orderDetails = _interopRequireDefault(__webpack_require__(/*! ./pages/order/orderDetails.vue */ 264));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 264:
/*!************************************************************!*\
  !*** D:/lixindom/2020/parent/pages/order/orderDetails.vue ***!
  \************************************************************/
/*! no static exports found */
...
/* harmony import */ var _orderDetails_vue_vue_type_template_id_a787a424_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./orderDetails.vue?vue&type=template&id=a787a424&scoped=true& */ 265);
/* harmony import */ var _orderDetails_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./orderDetails.vue?vue&type=script&lang=js& */ 267);
...
/* harmony import */ var _orderDetails_vue_vue_type_style_index_0_id_a787a424_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./orderDetails.vue?vue&type=style&index=0&id=a787a424&lang=scss&scoped=true& */ 269);
...
/***/ 265:
/*!*******************************************************************************************************!*\
  !*** D:/lixindom/2020/parent/pages/order/orderDetails.vue?vue&type=template&id=a787a424&scoped=true& ***!
  \*******************************************************************************************************/
...
/***/ 267:
/*!*************************************************************************************!*\
  !*** D:/lixindom/2020/parent/pages/order/orderDetails.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...

{
  ...
  methods: {
    cancelRefund: function cancelRefund() {var _this = this;
      uni.showLoading({
        title: '请稍后' });
      ...
      this._reqw.ipost(parmas, "cancelRefund").then(function (res) {
        res.result == 0 ? (_this.$api.tip('取消成功!'), _this.$api.back(), uni.hideLoading()) :
        _this.$api.tip(res.reultNote);
      }).catch(function (err) {});
    },
    btnCancle: function btnCancle(e) {var _this2 = this;
      var parmas = {
        mid: this.uid,
        oid: this.orderId,
        cancelReason: e };
      ...
      then(function (res) {
        console.log(res);
        res.result == 0 ? (_this2.$refs.cancelSuccess.showPicker(), _this2.$refs.refundList.hidePicker(), _this2.loadData()) :
        _this2.$api.tip(res.
        resultNote);
      }).
      catch(function (err) {});
    ...
    loadData: function loadData() {var _this3 = this;
      ...
      then(function (res) {
        console.log(res);
        res.result == 0 ? _this3.dataobject = res : _this3.$api.tip(res.
        resultNote);
      }).
      catch(function (err) {});
    },
    ...
    getData: function getData(url, type) {var _this4 = this;
      var parmas = {
        mid: this.uid,
        oid: this.orderId };
      ...
      ipost(parmas, url).
      then(function (res) {
        res.result == 0 ? (_this4.$api.tip("".concat(type, "\u6210\u529F")), _this4.$api.back()) :
        _this4.$api.tip(res.resultNote);
      }).
      catch(function (err) {});
    },
    payOrder: function payOrder() {var _this5 = this;
      var parmas = {
        mid: this.uid,
        oid: this.orderId };
      ...
      then(function (res) {
        res.result == 0 ? _this5.$api.onBridgeReady(res) :
...
/***/ 269:
/*!**********************************************************************************************************************!*\
  !*** D:/lixindom/2020/parent/pages/order/orderDetails.vue?vue&type=style&index=0&id=a787a424&lang=scss&scoped=true& ***!
  \**********************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
